...
bgImage.src = "../Sprites/AsteroidRacer/Blue_Nebula.png";
...
Earth.src = "../Sprites/AsteroidRacer/Earth.png";
Asteroid.src = "../Sprites/AsteroidRacer/Asteroid.png";
Moon.src = "../Sprites/AsteroidRacer/Moon.png";
Planet.src = "../Sprites/AsteroidRacer/Planet.png";
Planet1.src = "../Sprites/AsteroidRacer/Planet1.png";
Planet2.src = "../Sprites/AsteroidRacer/Planet2.png";
Planet3.src = "../Sprites/AsteroidRacer/Planet3.png";
Planet4.src = "../Sprites/AsteroidRacer/Planet4.png";
Planet5.src = "../Sprites/AsteroidRacer/Planet5.png";
...
rocketImage.src = "../Sprites/AsteroidRacer/rocket2.png"; // Replace with your rocket image path
...
function startTimer() {
  if (gameOver) window.location.href = "../index.html"; // Don't start the timer if the game is over
...
function update() {
  ...
  for (let i = 0; i < Objects.length; i++) {
    ...
    if (checkCollision({ x: rocketX, y: rocketY }, object)) {
      ...
      window.location.href = '../index.html'; // Stop further game processing (for a simple game over)
    }
