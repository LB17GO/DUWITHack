...
backgroundImage.src = '../Sprites/Whackemole/Purple_Nebula.png';

const AlienImage = new Image();
AlienImage.src = '../Sprites/Whackemole/Alien.png'; // Corrected typo (was "scr" instead of "src")
    ...
    timerInterval = setInterval(function () {
        if (timeLeft > 0) {
            ...
            if (counter >= 10) {
                ...
                localStorage.setItem("WhackBool", 'true');
